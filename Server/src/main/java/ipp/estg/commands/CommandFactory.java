...
public class CommandFactory {
    ...
    public CommandFactory(WorkerThread workerThread, IUserRepository userRepository, INotificationRepository notificationRepository,
        ...
        commandMap.put(CommandsFromClient.GET_EMERGENCY_RESOURCE_DISTRIBUTION, inputArray -> new GetAproveEmergencyResourceDistributionPendingApprovalsCommand(workerThread, userRepository, emergencyResourceDistributionRepository, inputArray));
        ...
        commandMap.put(CommandsFromClient.GET_ACTIVATING_EMERGENCY_COMMUNICATIONS, inputArray -> new GetApproveActivatingEmergencyCommunicationPendingApprovalsCommand(workerThread, userRepository, activatingEmergencyCommunicationsRepository, inputArray));
