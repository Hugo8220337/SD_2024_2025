...
public class CommandFactory {
    ...
    public CommandFactory(WorkerThread workerThread, IUserRepository userRepository, INotificationRepository notificationRepository,
        ...
        commandMap.put(CommandsFromClient.APPROVE_EMERGENCY_RESOURCE_DISTRIBUTION, inputArray -> new AproveEmergencyResourceDistributionCommand(server, workerThread, userRepository, emergencyResourceDistributionRepository, notificationRepository, inputArray, true));
        commandMap.put(CommandsFromClient.DENY_EMERGENCY_RESOURCE_DISTRIBUTION, inputArray -> new AproveEmergencyResourceDistributionCommand(server, workerThread, userRepository, emergencyResourceDistributionRepository, notificationRepository, inputArray, false));
